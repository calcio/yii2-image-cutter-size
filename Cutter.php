...
class Cutter extends \yii\widgets\InputWidget
{
    ...
    public function run()
    {
        ...
        echo Html::checkbox($this->attribute . '-remove', false, [
            'label' => Yii::t('mitrm/cutter/cutter', 'REMOVE')
        ]);

        Modal::begin([
            'header' => Html::tag('h4', Yii::t('mitrm/cutter/cutter', 'CUTTER')),
            'closeButton' => [],
        ...
        echo Html::label(Yii::t('mitrm/cutter/cutter', 'ASPECT_RATIO'), $inputField . '-aspectRatio');
    ...
    {
        Yii::$app->i18n->translations['mitrm/cutter/*'] = [
            'class' => 'yii\i18n\PhpMessageSource',
            'sourceLanguage' => 'en-US',
            'basePath' => '@vendor/mitrm/yii2-image-cutter/messages',
            'fileMap' => [
                'mitrm/cutter/cutter' => 'cutter.php',
            ],
        ];
    }
    ...
    private function getModalFooter($inputField)
    {
            ...
            'buttons' => [
                [
                    ...
                    'options' => [
                        ...
                        'title' => Yii::t('mitrm/cutter/cutter', 'DRAG_MODE_MOVE'),
                    ]
                ],
                [
                    ...
                    'options' => [
                        ...
                        'data-option' => 'crop',
                        'class' => 'btn btn-primary',
                        'data-title' => Yii::t('mitrm/cutter/cutter', 'DRAG_MODE_CROP'),
                    ]
                ],
            ],
            'options' => [
            ...
            'buttons' => [
                [
                    ...
                    'options' => [
                        ...
                        'data-method' => 'crop',
                        'class' => 'btn btn-primary',
                        'data-title' => Yii::t('mitrm/cutter/cutter', 'CROP'),
                    ]
                ],
                [
                    ...
                    'options' => [
                        ...
                        'data-method' => 'reset',
                        'class' => 'btn btn-primary',
                        'title' => Yii::t('mitrm/cutter/cutter', 'REFRESH'),
                    ]
                ],
                [
                    ...
                    'options' => [
                        ...
                        'data-method' => 'clear',
                        'class' => 'btn btn-primary',
                        'title' => Yii::t('mitrm/cutter/cutter', 'REMOVE'),
                    ]
                ],
            ],
            'options' => [
            ...
            'buttons' => [
                [
                    ...
                    'options' => [
                        ...
                        'data-option' => '0.1',
                        'class' => 'btn btn-primary',
                        'title' => Yii::t('mitrm/cutter/cutter', 'ZOOM_IN'),
                    ],
                ...
                [
                    ...
                    'options' => [
                        ...
                        'data-option' => '-0.1',
                        'class' => 'btn btn-primary',
                        'title' => Yii::t('mitrm/cutter/cutter', 'ZOOM_OUT'),
                    ],
                    'visible' => $this->cropperOptions['zoomable']
                ],
                [
                    ...
                    'options' => [
                        ...
                        'data-option' => '45',
                        'class' => 'btn btn-primary',
                        'title' => Yii::t('mitrm/cutter/cutter', 'ROTATE_LEFT'),
                    ],
                ...
                [
                    ...
                    'options' => [
                        ...
                        'data-option' => '-45',
                        'class' => 'btn btn-primary',
                        'title' => Yii::t('mitrm/cutter/cutter', 'ROTATE_RIGHT'),
                    ],
                    'visible' => $this->cropperOptions['rotatable']
                ],
            ],
            ...
            'buttons' => [
                [
                    ...
                    'options' => [
                        ...
                        'class' => 'btn btn-primary',
                        'title' => Yii::t('mitrm/cutter/cutter', 'SET_ASPECT_RATIO'),
                    ]
                ],
                [
                    ...
                    'options' => [
                        ...
                        'data-method' => 'setData',
                        'class' => 'btn btn-primary',
                        'title' => Yii::t('mitrm/cutter/cutter', 'SET_DATA'),
                    ]
                ],
            ],
            'options' => [
        ...
        Html::endTag('div') .
        Html::button(Yii::t('mitrm/cutter/cutter', 'CANCEL'), [
            'id' => $this->imageOptions['id'] . '_button_cancel', 'class' => 'btn btn-danger'
        ]) . Html::button(Yii::t('mitrm/cutter/cutter', 'ACCEPT'), [
